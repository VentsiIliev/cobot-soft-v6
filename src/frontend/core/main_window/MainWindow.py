...
from contour_editor.persistence.utils.utils import create_light_gray_pixmap, qpixmap_to_cv
...
from plugins.core.contour_editor.workpiece_editor import WorkpieceAdapter
...
class MainWindow(TranslatableWidget):
    ...
    def close_all_apps(self):
        ...
        for name, widget in list(self.running_widgets.items()):
            if not widget:
                continue
            widget.clean_up()
