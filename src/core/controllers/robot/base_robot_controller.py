...
class BaseRobotController(BaseController):
    ...
    def _handle_move_to_calib_pose(self):
        print(f"base_robot_controller: Handling move to calibration pose")
    ...
    def _handle_jog(self, parts):
        ...
        try:
            ...
            print(f"[RobotController]: JOG request parsed - Axis: {axis_enum}, Direction: {direction}, Step: {step}")
        except Exception:
            import traceback
            traceback.print_exc()
