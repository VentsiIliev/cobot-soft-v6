...
class ContourEditorAppWidget(AppWidget):
    ...
    def handle_execute_callback(self, workpiece_data):
        ...
        if 'editor_data' in workpiece_data:
            from plugins.core.contour_editor.workpiece_editor.adapters.workpiece_adapter import WorkpieceAdapter
    ...
    def _build_workpiece_editor(self):
        ...
        from plugins.core.contour_editor.workpiece_editor.builder import WorkpieceEditorBuilder
        from plugins.core.contour_editor.workpiece_editor.config.segment_settings_provider import SegmentSettingsProvider
        from plugins.core.contour_editor.workpiece_editor.config.glue_settings_provider import GlueSettingsProvider
        from plugins.core.contour_editor.workpiece_editor.config.virtual_keyboard_widget_factory import VirtualKeyboardWidgetFactory
        from plugins.core.contour_editor.workpiece_editor.config.workpiece_form_factory import WorkpieceFormFactory
        from contour_editor import BezierSegmentManager, SettingsConfig, SettingsGroup

        # Import glue dispensing specific configurations
