import json
import os
from modules.utils.path_interpolation.combined_interpolation import interpolate_path_two_stage
from modules.utils.path_interpolation.debug_plotting import plot_trajectory_debug
...
def main():
    ...
    plot_trajectory_debug(
        original_paths=[xyz_points],
        linear_paths=[linear_result],
        spline_paths=[spline_result],
