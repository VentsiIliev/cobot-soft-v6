...
from deprecated.pl_gui.customWidgets.CustomWarningDialog import CustomWarningDialog
...
from deprecated.pl_gui.Endpoints import QR_LOGIN, GO_TO_LOGIN_POS, UPDATE_CAMERA_FEED, START_CONTOUR_DETECTION, \
    STOP_CONTOUR_DETECTION
